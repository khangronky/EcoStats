...
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c1
           FROM CityTemp WHERE Year BETWEEN 1920 AND 1920 + 10 GROUP BY CityID) t2
ON t1.CityID = t2.CityID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c2
           FROM CityTemp WHERE Year BETWEEN 1930 AND 1930 + 10 GROUP BY CityID) t3
ON t1.CityID = t3.CityID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c3
           FROM CityTemp WHERE Year BETWEEN 1990 AND 1990 + 10 GROUP BY CityID) t4
ON t1.CityID = t4.CityID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c4
           FROM CityTemp WHERE Year BETWEEN 2000 AND 2000 + 10 GROUP BY CityID) t5
ON t1.CityID = t5.CityID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c5
           FROM CityTemp WHERE Year BETWEEN 2003 AND 2003 + 10 GROUP BY CityID) t6
...
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c1
           FROM StateTemp WHERE Year BETWEEN 1920 AND 1920 + 10 GROUP BY StateID) t2
ON t1.StateID = t2.StateID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c2
           FROM StateTemp WHERE Year BETWEEN 1930 AND 1930 + 10 GROUP BY StateID) t3
ON t1.StateID = t3.StateID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c3
           FROM StateTemp WHERE Year BETWEEN 1990 AND 1990 + 10 GROUP BY StateID) t4
ON t1.StateID = t4.StateID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c4
           FROM StateTemp WHERE Year BETWEEN 2000 AND 2000 + 10 GROUP BY StateID) t5
ON t1.StateID = t5.StateID
LEFT JOIN (SELECT *, CASE WHEN COUNT(AvgTemp) = 10 + 1 THEN ROUND(AVG(AvgTemp), 3) ELSE NULL END c5
           FROM StateTemp WHERE Year BETWEEN 2003 AND 2003 + 10 GROUP BY StateID) t6
...
LEFT JOIN (SELECT * FROM CountryTemp WHERE Year BETWEEN 1750 AND 2013 - 10) t2 ON t1.CountryID = t2.CountryID
LEFT JOIN (SELECT * FROM CountryTemp WHERE Year BETWEEN 1750 + 10 AND 2013) t3 ON t1.CountryID = t3.CountryID AND t3.Year = t2.Year + 10
LEFT JOIN (SELECT * FROM CountryPopulation WHERE Year BETWEEN 1960 AND 2013 - 10) t4 ON t1.CountryID = t4.CountryID AND t4.Year = t2.Year
LEFT JOIN (SELECT * FROM CountryPopulation WHERE Year BETWEEN 1960 + 10 AND 2013) t5 ON t1.CountryID = t5.CountryID AND t5.Year = t4.Year + 10
